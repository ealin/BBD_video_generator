...
def generate_videos_from_txt_and_mp3(txt_dir, voice_dir, output_dir):
    """
    ...
    topic_font_background_color = 'red'
...
# 使用示例
generate_videos_from_txt_and_mp3("./txt68", "./voice68", "./video")
