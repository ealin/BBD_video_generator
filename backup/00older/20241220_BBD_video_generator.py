...
def generate_videos_from_txt_and_mp3(txt_dir, voice_dir, bg_img_dir, output_file, start_second, topic_index):
    ...
    max_line = 16    # 0 means no limited
...
# 製作長背景音樂 (from .mp3)
#create_audio_from_mp3s("./bg_mp3", 16*60, "output.mp3")


# 製作長背景影片 (from .mp4)
#create_random_video_from_directory("./主題影片/健康食物", 60*16, "健康食物.mp4")
...
'''
# step1:  背景圖轉檔
for i in range(0,15):   # range(1:10) <== 1~9
...
# step2: 產生影片-1
#generate_videos_from_txt_and_mp3("./腳本/txt69-1", "./腳本/voice69-1", "./bg_image/B69","./output1.mp4",0,0)  #4th parameter: start time (in second)

# step2: 產生影片-2
#generate_videos_from_txt_and_mp3("./腳本/txt69-2", "./腳本/voice69-2", "./bg_image/B69", "./output2.mp4",438,3) # 最後一個參數：從第幾個topic開始, start from 0.jpg
