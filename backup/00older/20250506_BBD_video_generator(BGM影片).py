...
BGM_length = 11         # 背景音樂長度 / 單位：分鐘
BGM_output_filename = "創業.mp3"

# function = 2 製作長背景影片 (from .mp4)
A_roll_MP4_length = 12    # A-roll (由MP4組成) 長度 / 單位：分鐘
A_roll_MP4_dir = "黑膠播放"   # mp4目錄名稱

# function = 3 製作長背景影片 (from .jpg)
A_roll_JPG_length = 20         # A-roll (由JPG組成) 長度 / 單位：分鐘
Each_JPG_Length = 15           # 每張JPG顯示多久時間   / 單位：秒
A_roll_JPG_dir = "Trump"       # .jpg 目錄名稱
...
total_png_photo_no = 11    # 共有幾張圖(.png)   e.g. 10 means 0-9
photo_dir = "./bg_image/bg91"    #"./主題圖片/trump" #"./bg_image/bg89" 
...
if function == 6:
    ...
    create_audio_from_mp3s(None, "./bg_mp3", video_length3, "output.mp3")
...
if function == 7:
    First_audio_filename = "./bg_mp3/原始音量/StockTune-Whispers Of The Forgotten_1746450988.mp3"
    music_program_length = 25  # unit : minutes
    ...
    # function-3
    #create_video_from_images(mix_mode, "./主題圖片/"+A_roll_JPG_dir, Each_JPG_Length, music_program_length, A_roll_JPG_dir+"2.mp4")

    create_countdown_video(
        minutes=music_program_length,
        seconds=0,
