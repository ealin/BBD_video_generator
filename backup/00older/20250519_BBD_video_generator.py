    ...
    try:
        ...
        while total_duration < t2:
            for audio_file in audio_files:
                ...
                print(format_seconds_to_hms(total_duration) + " " + audio_file)
...
total_png_photo_no = 13    # 共有幾張圖(.png)   e.g. 10 means 0-9
photo_dir = "./bg_image/bg94"    #"./主題圖片/trump" #"./bg_image/bg89" 
...
if function == 7:
    First_audio_filename = "./bg_mp3/原始音量/Whispers Of The Heartland.mp3"
    music_program_length = 30  # unit : minutes
    A_roll_JPG_dir = "Money"
    ...
    create_countdown_video(
        ...
        fontsize=100,
        color= (0,71,125), #水手藍  #(222,49,99),  #樱桃红  #(250,128,114), #(255,191,0), #琥珀色,    #(46, 139,87) , #"yellow",
        position=(10, 10),
