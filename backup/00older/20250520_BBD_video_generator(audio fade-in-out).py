...
photo_dir = "./bg_image/bg95"    #"./主題圖片/trump" #"./bg_image/bg89" 
...
if function == 7:
    First_audio_filename = "./bg_mp3/原始音量/Quiet Winter's Embrace.mp3"
    music_program_length = 10  # unit : minutes
    A_roll_JPG_dir = "宇宙"
    A_roll_MP4_dir = "宇宙"
    Each_JPG_Length = 20
    ...
    create_countdown_video(
        ...
        fontsize=100,
        color= (139,0,255),#紫羅蘭  #(0,71,125), #水手藍  #(222,49,99),  #樱桃红  #(250,128,114), #(255,191,0), #琥珀色,    #(46, 139,87) , #"yellow",
        position=(10, 10),
