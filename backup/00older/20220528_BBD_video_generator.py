...
A_roll_JPEG_length = 1         # A-roll (由JPEG組成) 長度 / 單位：分鐘
Each_JPEG_Length = 45           # 每張JPEG顯示多久時間   / 單位：秒
A_roll_JPEG_dir = "鄭成功"        # .jpeg 目錄名稱
...
# function = 3 製作長背景影片 (from .jpeg)
if function == 3:
    create_video_from_images("./主題圖片/"+A_roll_JPEG_dir, Each_JPEG_Length, 60*A_roll_JPEG_length, A_roll_JPEG_dir+"2.mp4")
...
if function == 6:
    ...
    create_video_from_images("./主題圖片/"+A_roll_JPEG_dir, Each_JPEG_Length, video_length3, A_roll_JPEG_dir+"2.mp4")
