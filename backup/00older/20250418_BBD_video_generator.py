...
BGM_length = 20         # 背景音樂長度 / 單位：分鐘
BGM_output_filename = "m4a.mp3"
...
A_roll_JPG_length = 11         # A-roll (由JPG組成) 長度 / 單位：分鐘
Each_JPG_Length = 20           # 每張JPG顯示多久時間   / 單位：秒
A_roll_JPG_dir = "春上村樹"       # .jpg 目錄名稱
...
total_png_photo_no = 9    # 共有幾張圖(.png)   e.g. 10 means 0-9
photo_dir = "./bg_image/bg88"   #"./主題圖片/春上村樹"
