...
# 製作長背景音樂 (from .mp3)
create_audio_from_mp3s("./bg_mp3", 24*60, "AI.mp3")


# 製作長背景影片 (from .mp4)
#create_random_video_from_directory("./主題影片/程式", 60*24, "AI.mp4")
...
# step1:  背景圖轉檔
'''
for i in range(0,16):   # range(1:10) <== 1~9
    image_filename = os.path.join('./bg_image/B70', f"{i}.webp")
...
# step2: 產生影片-1
#generate_videos_from_txt_and_mp3("./腳本/txt70-1", "./腳本/voice70-1", "./bg_image/B70","./output1.mp4",0,0)  #4th parameter: start time (in second)

# step2: 產生影片-2
#generate_videos_from_txt_and_mp3("./腳本/txt70-2", "./腳本/voice70-2", "./bg_image/B70", "./output2.mp4",416,7) # 最後一個參數：從第幾個topic開始, start from 0.jpg

# step3: 產生影片-3
#generate_videos_from_txt_and_mp3("./腳本/txt70-3", "./腳本/voice70-3", "./bg_image/B70", "./output3.mp4",892,11) # 最後一個參數：從第幾個topic開始, start from 0.jpg
